...
void display()
{
   ...
   glUseProgram(life);
   id = glGetUniformLocation(life,"img");
   if (id >= 0) glUniform1i(id, 0);
   id = glGetUniformLocation(life,"board");
   if (id >= 0) glUniform1i(id, 1);
   id = glGetUniformLocation(life,"dX");
   if (id >= 0) glUniform1f(id, 1.0/w);
   id = glGetUniformLocation(life,"dY");
   if (id >= 0) glUniform1f(id, 1.0/h);
...
int main(int argc, char *argv[])
{
   ...
   life   = CreateShaderProg(NULL, (char*)"life.frag");
