...
//Normal Polar-Cartesian transformation/summation function
...
void sphere(float arr[][12], float r, float g, float b)
{
   ...
   for (int ph = 90; ph >= -90+d; ph -= d)
   {
      for (int th = 0; th < 360; th += d)
      {
         ...
         NE[0] = Sin(th+d)*Cos(th+d);
         NE[1] = Sin(ph);
         NE[2] = Cos(th+d)*Cos(ph);
         NE[3] = (th+d)/360.0;
         NE[4] = (ph+90)/180.0;

         SW[0] = Sin(th)*Cos(th);
         SW[1] = Sin(ph-d);
         SW[2] = Cos(th)*Cos(ph-d);
         SW[3] = (th)/360.0;
         SW[4] = (ph-d+90)/180.0;

         SE[0] = Sin(th+d)*Cos(th+d);
         SE[1] = Sin(ph);
         SE[2] = Cos(th+d)*Cos(ph);
         SE[3] = (th+d)/360.0;
         SE[4] = (ph+90)/180.0;
         ...
         arr[arrPos+1][8] =     g;
         arr[arrPos+1][9] =     b;
         arr[arrPos+1][10]= SW[3];
         arr[arrPos+1][11]= SW[4];
         ...
         arr[arrPos+2][8] =     g;
         arr[arrPos+2][9] =     b;
         arr[arrPos+2][10]= SE[3];
         arr[arrPos+2][11]= SE[4];
         ...
         arr[arrPos+3][8] =     g;
         arr[arrPos+3][9] =     b;
         arr[arrPos+3][10]= SE[3];
         arr[arrPos+3][11]= SE[4];
         ...
         arr[arrPos+4][8] =     g;
         arr[arrPos+4][9] =     b;
         arr[arrPos+4][10]= NE[3];
         arr[arrPos+4][11]= NE[4];
         ...
         arr[arrPos+5][8] =     g;
         arr[arrPos+5][9] =     b;
         arr[arrPos+5][10]= NW[3];
         arr[arrPos+5][11]= NW[4];
