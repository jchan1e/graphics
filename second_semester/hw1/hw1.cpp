...
void display()
{
   ...
   for (int i=0; i < 16; ++i)
   {
      if (objects[i] != 0)
      {
         ...
         {
         case 1:
            ball(        Sin(t+22.5*i), Sin(t/2.0+22.5*i), Cos(t+22.5*i),           0.125);
            break;
         case 2:
            cube(        Sin(t+22.5*i), Sin(t/2.0+22.5*i), Cos(t+22.5*i), t+22.5*i, 0.125);
            break;
         case 3:
            octahedron(  Sin(t+22.5*i), Sin(t/2.0+22.5*i), Cos(t+22.5*i), t+22.5*i, 0.125);
            break;
         case 4:
            dodecahedron(Sin(t+22.5*i), Sin(t/2.0+22.5*i), Cos(t+22.5*i), t+22.5*i, 0.125);
            break;
         case 5:
            icosahedron( Sin(t+22.5*i), Sin(t/2.0+22.5*i), Cos(t+22.5*i), t+22.5*i, 0.125);
            break;
         default:
            break;
         }
   ...
   octahedron( 0.0, 2.0, 0.0, 0.0, 0.125);
   octahedron( 0.0,-2.0, 0.0, 0.0, 0.125);
   octahedron( 2.0, 0.0, 0.0, 0.0, 0.125);
   octahedron(-2.0, 0.0, 0.0, 0.0, 0.125);
   octahedron( 0.0, 0.0, 2.0, 0.0, 0.125);
   octahedron( 0.0, 0.0,-2.0, 0.0, 0.125);
...
void reshape(int width, int height)
{
   ...
   //adjust projection
   if (perspective)
      gluPerspective(60, w2h, 1.0/80, 80);
   else
...
int main(int argc, char *argv[])
{
   ...
   shader = CreateShaderProg((char*)"hw1.vert", (char*)"hw1.frag");
