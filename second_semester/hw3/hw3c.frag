...
void main()
{
   ...
   {
      vec3 colorA = mix(vec3(0.0, 0.0,0.75), vec3(0.0, 2.0, 0.0), float(j)/100.0);
      vec3 colorB = mix(vec3(0.0, 2.0, 0.0), vec3(1.0, 0.0, 0.5), float(j)/100.0);
      texturecolor = mix(colorA, colorB, float(j)/100.0);
   }
